...
export const Docs: FC<Props> = memo(({  }) => {
  ...
  return (
    ...
    <td>The first argument that receives the <a target="_blank" href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date/toLocaleString"><code>Date.toLocaleString</code></a> function.</td>
    <td><code>null</code></td>
    </tr>
    <tr>
    <td>localeString.formatOptions</td>
    <td><code>Intl.DateTimeFormatOptions</code></td>
    <td>The second argument that receives the <a target="_blank" href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date/toLocaleString"><code>Date.toLocaleString</code></a> function.</td>
    <td><code>null</code></td>
    </tr>
    <tr>
    <td>exclude</td>
...
`[
  ...
  { dateStr: '2023-09-06T14:30:00', timeStr: '14:30:00' }
    ...
    <div> &#10003; Add exclude functionality</div>
    <div> &#10003; Error handling</div>
    <div> &#10003; Custom error handling</div>
    <div> &#10003; Custom timezone</div>
    <div> &#10003; Repeating by backward</div>
    <div> &minus; Support date short formatting (e.g. dd/mm/yyyy)</div>
    ...
    <p>If you have a suggestion that would make this better, please fork the <a target="_blank" href="https://github.com/NavasardianMichael/recur-date-based">Github Repository</a> and create a pull request. You can also simply open an issue with the tag &quot;enhancement&quot;.
    ...
    <p>Michael Navasardyan - <a target="_blank" href='mailto:navasardianmichael@gmail.com'>navasardianmichael@gmail.com</a></p>
    <p>Project Link: <a href="https://github.com/NavasardianMichael/recur-date-based">https://github.com/NavasardianMichael/recur-date-based</a></p>
    </div>
  )
})